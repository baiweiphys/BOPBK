function [w,eigVec] = solver_mixed(kx,kz,theta,plasmaParams,sp,EPS0)
...
by20_pbk = 1i*epsilon0*sum(wps_pbk.^2); % fixed bug by baiwei, 2025.10.22
...
%% for bi-Maxwellian distribution plasma
...
Mx_pbk = Mxy_pbk_mixed(S_pbk,Ns_pbk,Ns_bm,kappasz_pbk,J,csn, ...
                       bx11snl,bx21snl,bx31snl,bx12snl,bx22snl,bx32snl, ...
                       bx33snl,bx10_pbk,1,5,4,3,5); % Matrix No.1

My_pbk = Mxy_pbk_mixed(S_pbk,Ns_pbk,Ns_bm,kappasz_pbk,J,csn, ...
                       by11snl,by21snl,by31snl,by12snl,by22snl,by32snl, ...
                       by33snl,by20_pbk,2,5,4,3,4); % Matrix No.2

Mz_pbk = Mz_pbk_mixed(S_pbk,Ns_pbk,Ns_bm,kappasz_pbk,J,csn, ...
...
Mx_bm = M_mixed_maxwell(S_bm,Ns_pbk,Ns_bm,kappasz_pbk,J,csnj,bx1snj,bx2snj,bx3snj,4,5,4,3); % Matrix No.4
My_bm = M_mixed_maxwell(S_bm,Ns_pbk,Ns_bm,kappasz_pbk,J,csnj,by1snj,by2snj,by3snj,5,5,4,3); % Matrix No.5
Mz_bm = M_mixed_maxwell(S_bm,Ns_pbk,Ns_bm,kappasz_pbk,J,csnj,bz1snj,bz2snj,bz3snj,6,5,4,3); % Matrix No.6

%% Step 3: Assemble matrix based on the maxied distribution of PBK and BM plasmas.
...
% disp(['size(Mx_bm) = ',num2str(size(Mx_bm))]);
% disp(['size(My_bm) = ',num2str(size(My_bm))]);
% disp(['size(Mz_bm) = ',num2str(size(Mz_bm))]);
...
%% Step 5: The perturbed currents of first term of BM
%
...
%% Step 5.2: The perturbed currents of Maxwell's equations for the bi-Maxwellian plasmas
