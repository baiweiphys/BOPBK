function b34snj = mk2_b34snj(s,n,jj,kz,kappasx,kappasx_th,J_opt,vtsz,Tsz,Tsx,sgms,wcs,lambdas,norm_omega,EPS0)
% MK2_B34SNJ Calculate the coefficients of b34snj.
...
if kappasx(s)<kappasx_th(s)
    % Maxwellian-kappa (MK)
    S3_pbk = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,1,1,2,1,EPS0);
    S4_pbk = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,1,1,2,0,EPS0);
    S8_pbk = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,1,1,0,0,EPS0);
    S38_pbk = @(s,n) (kappasx(s)+sgms(s))/kappasx(s)*S3_pbk(s,n)...
