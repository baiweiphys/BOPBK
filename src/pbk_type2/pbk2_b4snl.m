function b4snl = pbk2_b4snl(s,n,l,kz,kappasz,kappasx,vtsz,vtsx,sgms,lambdas,norm_omega,EPS0)
% PBK2_B4SNL Calculate the coefficient b4snl.
% @Description: Calculate the coefficients of b4snl for the oblique 
% plasma waves with a loss-cone PBK distribution (type 2).
% @Filename: pbk2_b4snl.m
% @Author: Bai Wei (baiweiphys@gmail.com)
% @Date: 2023-11-20
% @Modification: 
%   Bai Wei, 2026.04.01: add norm_omega.
%   Bai Wei, 2026.04.04: only update S4 for pbk type2.
...
% PBK type 2
S4 = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,1,1,2,0,EPS0);

% PBK type 2
% bsl = @(s,l) pbk2_bsl(s,l,kappasz,vtsz,vtsx,kz,norm_omega);
b4snl = S4(s,n) * pbk2_bsl(s,l,kappasz,vtsz,vtsx,kz,norm_omega);
