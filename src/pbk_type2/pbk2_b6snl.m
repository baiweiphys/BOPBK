function b6snl = pbk2_b6snl(s,n,l,kz,kappasz,kappasx,vtsz,vtsx,sgms,lambdas,norm_omega,EPS0)
% PBK2_B6SNL Calculate the coefficient b6snl.
% @Description: Calculate the coefficients of b6snl for the oblique 
% plasma waves with a PBK distribution (type 2).
% @Filename: pbk2_b6snl.m
% @Author: Bai Wei (baiweiphys@gmail.com)
% @Date: 2023-11-20
% @Modification: 
%   Bai Wei, 2026.04.01: add norm_omega.
%   Bai Wei, 2026.04.04: only update S6 for pbk type2.
...
% PBK type 2
S6 = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,0,2,3,0,EPS0);

% PBK type 2
% bsl = @(s,l) pbk2_bsl(s,l,kappasz,vtsz,vtsx,kz,norm_omega);
b6snl = S6(s,n) * pbk2_bsl(s,l,kappasz,vtsz,vtsx,kz,norm_omega);
