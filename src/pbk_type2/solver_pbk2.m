function [w,eigVec] = solver_pbk2(kx,kz,theta,plasmaParams,sp,norm_omega,EPS0)
% SOLVER_PBK2 To solve for the wave mode roots in the PBK2 solver. 
% @Description: To solve for the wave mode roots of the oblique plasma wave 
% model using the loss-cone PBK (type 2) distribution, the transverse wave 
% number kx and longitudinal wave number kz are specified.
% @Filename: solver_pbk2.m
...
% PBK type 2
b1snl = @(s,n,l) pbk2_b1snl(s,n,l,kz,kappasz,kappasx,vtsz,sgms,wcs,lambdas,norm_omega,EPS0);
b2snl = @(s,n,l) pbk2_b2snl(s,n,l,kz,kappasz,kappasx,vtsz,vtsx,sgms,lambdas,norm_omega,EPS0);
b3snl = @(s,n,l) pbk2_b3snl(s,n,l,kz,kappasz,kappasx,vtsz,sgms,wcs,lambdas,norm_omega,EPS0);
b4snl = @(s,n,l) pbk2_b4snl(s,n,l,kz,kappasz,kappasx,vtsz,vtsx,sgms,lambdas,norm_omega,EPS0);
b5snl = @(s,n,l) pbk2_b5snl(s,n,l,kz,kappasz,kappasx,vtsz,sgms,wcs,lambdas,norm_omega,EPS0);
b6snl = @(s,n,l) pbk2_b6snl(s,n,l,kz,kappasz,kappasx,vtsz,vtsx,sgms,lambdas,norm_omega,EPS0);
...
% Step 1
% PBK type 2
Mx = Mxy_pbk2(S,Ns,kappasz,csn,bx11snl,bx21snl,bx31snl, ...
            bx12snl,bx22snl,bx32snl,bx33snl,bx10_pbk,1,5,4,3,5); % Matrix No.1

My = Mxy_pbk2(S,Ns,kappasz,csn,by11snl,by21snl,by31snl, ...
            by12snl,by22snl,by32snl,by33snl,by20_pbk,2,5,4,3,4); % Matrix No.2
 
Mz = Mz_pbk2(S,Ns,kappasz,csn,bz11snl,bz21snl,bz31snl, ...
...
% PBK type 2
idx_Jx_pbk = getIndexOfBlkMatrix_pbk2(Ns,kappasz,1);
...
% PBK type 2
idx_Jy_pbk = getIndexOfBlkMatrix_pbk2(Ns,kappasz,2);
...
% PBK type 2
idx_Jz_pbk = getIndexOfBlkMatrix_pbk2(Ns,kappasz,3);
