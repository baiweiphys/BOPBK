function b3snl = pbk2_b3snl(s,n,l,kz,kappasz,kappasx,vtsz,sgms,wcs,lambdas,norm_omega,EPS0)
% PBK2_B3SNL Calculate the coefficient b3snl. 
% @Description: Calculate the coefficients of b3snl for the oblique 
% plasma waves with a loss-cone PBK distribution (type 2).
% @Filename: pbk2_b3snl.m
% @Author: Bai Wei (baiweiphys@gmail.com)
% @Date: 2023-11-20
% @Modification: 
%   Bai Wei, 2026.04.01: add norm_omega.
%   Bai Wei, 2026.04.04: only update S3, S8, and S38 for pbk type2.
...
% PBK type 2
S3 = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,1,1,2,1,EPS0);
S8 = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,1,1,0,0,EPS0);
S38 = @(s,n) (kappasx(s)+sgms(s))/kappasx(s)*S3(s,n)...
    -2*sgms(s)*lambdas(s)*S8(s,n);


% PBK type 2
% bsnl = @(s,n,l) pbk2_bsnl(s,n,l,kappasz,vtsz,wcs,kz,norm_omega);
b3snl = S38(s,n) * pbk2_bsnl(s,n,l,kappasz,vtsz,wcs,kz,norm_omega);
