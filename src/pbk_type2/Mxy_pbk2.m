function M = Mxy_pbk2(S_pbk,Ns_pbk,kappasz_pbk,csn_pbk, ...
                    bxy11snl,bxy21snl,bxy31snl, ...
                    bxy12snl,bxy22snl,bxy32snl, ...
                    bxy33snl,bx10_by20, ...
                    MatrixNo,ExNo,EyNo,EzNo,ExyNo)
% MXY_PBK2 Assemble the x- or y-direction PBK2 submatrix.
% @Description: To obtain matrix Mxy_pbk2 for PBK (type 2) plasmas 
% in x- or y-direction.
% @Filename: Mxy_pbk2.m
...
% Step 1: Obtain the dimensions of submatrix M_pbk2 (PBK type2).
% PBK type 2
    ...
    for ind_n=1:(2*Ns_pbk(s)+1)
        ...
        for l = 1:kappasz_pbk(s)
            for jj = 1:l+1
                ...
                if(jj<l+1) 
                    % snljp1 = index_M_pbk2(s,idx_n,l,jj+1);
