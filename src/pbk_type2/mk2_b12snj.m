function b12snj = mk2_b12snj(s,n,jj,kz,kappasx,kappasx_th,J_opt,vtsz,Tsz,Tsx,sgms,wcs,lambdas,norm_omega,EPS0)
% MK2_B12SNJ Calculate the coefficients of b12snj. 
...
%   Bai Wei, 2026.04.04: update S1, S2, S7 and S17 for pbk type2.
...
if kappasx(s)<kappasx_th(s)
    % Maxwellian-kappa (MK)
    S1_pbk = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,2,0,1,1,EPS0);
    S2_pbk = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,2,0,1,0,EPS0);
    S7_pbk = @(s,n) funcS_pbk2(s,n,kappasx,lambdas,sgms,2,0,-1,0,EPS0);
    S17_pbk = @(s,n) (kappasx(s)+sgms(s))/kappasx(s)*S1_pbk(s,n) ...
