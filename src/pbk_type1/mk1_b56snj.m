function b56snj = mk1_b56snj(s,n,jj,kz,kappasx,kappasx_th,J_opt,vtsz,Tsz,Tsx,sgms,wcs,lambdas,norm_omega,EPS0)
...
if kappasx(s)<kappasx_th(s)
    % Maxwellian-kappa (MK)
    S5_pbk = @(s,n) funcS_pbk1(s,n,kappasx,lambdas,sgms,0,2,3,2,EPS0);
    S6_pbk = @(s,n) funcS_pbk1(s,n,kappasx,lambdas,sgms,0,2,3,1,EPS0);
    S9_pbk = @(s,n) funcS_pbk1(s,n,kappasx,lambdas,sgms,0,2,1,1,EPS0);
    S59_pbk = @(s,n) (kappasx(s)+sgms(s)+1)/kappasx(s)*S5_pbk(s,n) ...
