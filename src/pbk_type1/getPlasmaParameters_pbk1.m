function plasmaParams = getPlasmaParameters_pbk1(B0,par,J_opt) 
% GETPLASMAPARAMETERS_PBK1 To obtain the plasma parameters.
% @Description: To obtain the plasma parameters.
% @Filename: getPlasmaParameters_pbk1.m
% @Date: 2022-01-05
% @Modification: 
