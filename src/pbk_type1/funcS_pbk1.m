function funcS = funcS_pbk1(s,n,kappasx,lambdas,sgms,p1,p2,p3,p4,EPS0)
% FUNCS_PBK Compute the integral of funcS_pbk.
% @Description: Compute the integral of funcS_pbk for loss-cone PBK model.
% @Filename: funcS_pbk1.m
% @Author: Bai Wei (baiweiphys@gmail.com)
% @Date: 2023-11-20
% @Modification: 
%   Bai Wei, 2026.03.31: FuncS_pbk1 Optimization.
%   Bai Wei, 2026.04.04: only update S0 for pbk type1.

%% example:
% funcS = @(Jnum,dJnum,num,den) funcS_pbk1(s,n,kappas_perp,lambdas,sgms,Jnum,dJnum,num,den,EPS0)
