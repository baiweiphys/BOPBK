function ind = getIndexOfBlkMatrix_mixed_pbk1(Ns_pbk,Ns_mk,kappasz_pbk,J,MatrixNo)
% GETINDEXOFBLKMATRIX_MIXED_PBK1 To obtain the index of a sub-matrix in the mixed solver. 
% @Description: To obtain the index of a sub-matrix within a composite 
% matrix that exhibits a mixed plasma distribution of PBK (type 1) 
% and Maxwellian-kappa (MK).
% @Filename: getIndexOfBlkMatrix_mixed_pbk1.m
