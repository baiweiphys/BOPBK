...
S3 = @(s,n) funcS_pbk(s,n,kappasx,lambdas,sgms,1,1,2,2,EPS0);
S8 = @(s,n) funcS_pbk(s,n,kappasx,lambdas,sgms,1,1,0,1,EPS0);
S38 = @(s,n) (kappasx(s)+sgms(s)+1)/kappasx(s)*S3(s,n)...
    -2*sgms(s)*lambdas(s)*S8(s,n);

bsnl = @(s,n,l) pbk_bsnl(s,n,l,kappasz,vtsz,wcs,kz);
b3snl = S38(s,n) * bsnl(s,n,l);
