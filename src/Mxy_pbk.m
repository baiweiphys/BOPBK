function M = Mxy_pbk(S_pbk,Ns_pbk,kappasz_pbk,csn_pbk, ...
                    bxy11snl,bxy21snl,bxy31snl, ...
                    bxy12snl,bxy22snl,bxy32snl, ...
                    bxy33snl,bx10_by20, ...
                    MatrixNo,ExNo,EyNo,EzNo,ExyNo)
% @Description: To obtain matrix Mxy_pbk for loss-cone PBK plasmas 
% in x- or y-direction.
% @Filename: Mxy_pbk.m
...
% Step 1: Obtain the dimensions of submatrix Mpbk.
