...
save('Basu2011PoPFig7_TizTix=5_sig=1_bm.mat','pas','wws');
...
print(gcf,'-depsc',['Basu2011PoPFig7_TizTix=5_sig=1_bm_','select.eps']);
savefig(['Basu2011PoPFig7_TizTix=5_sig=1_bm_','select.fig']);
