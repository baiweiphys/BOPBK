...
save('saveData_Cattaert2007Fig9_TexTez0dot5.mat','pas','wws');
...
print(gcf,'-depsc',['Cattaert2007Fig9_TexTez0dot5_','select.eps']);
savefig(['Cattaert2007Fig9_TexTez0dot5_','select.fig']);
