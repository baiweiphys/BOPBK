...
save('Santos2014Fig6b_TixTiz=0.6_pbki5.mat','pas','wws');
...
print(gcf,'-depsc',['Santos2014Fig6b_TixTiz=0.6_pbki5_','select.eps']);
savefig(['Santos2014Fig6b_TixTiz=0.6_pbki5_','select.fig']);
