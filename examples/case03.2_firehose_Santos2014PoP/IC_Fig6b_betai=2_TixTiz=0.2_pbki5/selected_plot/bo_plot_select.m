...
save('Santos2014Fig6b_TixTiz=0.2_pbki5.mat','pas','wws');
...
print(gcf,'-depsc',['Santos2014Fig6b_TixTiz=0.2_pbki5_','select.eps']);
savefig(['Santos2014Fig6b_TixTiz=0.2_pbki5_','select.fig']);
