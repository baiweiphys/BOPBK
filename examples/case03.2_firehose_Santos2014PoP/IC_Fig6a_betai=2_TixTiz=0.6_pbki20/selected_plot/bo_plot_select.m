...
save('Santos2014Fig6a_TixTiz=0.6_pbki20.mat','pas','wws');
...
print(gcf,'-depsc',['Santos2014Fig6a_TixTiz=0.6_pbki20_','select.eps']);
savefig(['Santos2014Fig6a_TixTiz=0.6_pbki20_','select.fig']);
