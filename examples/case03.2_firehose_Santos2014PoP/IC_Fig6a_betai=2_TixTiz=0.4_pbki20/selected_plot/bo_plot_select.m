...
save('Santos2014Fig6a_TixTiz=0.4_pbki20.mat','pas','wws');
...
print(gcf,'-depsc',['Santos2014Fig6a_TixTiz=0.4_pbki20_','select.eps']);
savefig(['Santos2014Fig6a_TixTiz=0.4_pbki20_','select.fig']);
