...
save('Santos2015Fig6a_IC_TixTiz=5_pbki20.mat','pas','wws');
...
print(gcf,'-depsc',['Santos2015Fig6a_IC_TixTiz=5_pbki20_','select.eps']);
savefig(['Santos2015Fig6a_IC_TixTiz=5_pbki20_','select.fig']);
