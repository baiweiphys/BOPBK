...
save('Santos2016PoPFig1_PFHI_TizTix=0.2_bm.mat','pas','wws');
...
print(gcf,'-depsc',['Santos2016PoPFig1_PFHI_TizTix=0.2_bm_','select.eps']);
savefig(['Santos2016PoPFig1_PFHI_TizTix=0.2_bm_','select.fig']);
