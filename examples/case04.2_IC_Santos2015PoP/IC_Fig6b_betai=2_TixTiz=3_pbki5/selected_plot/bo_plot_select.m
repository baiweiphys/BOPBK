...
save('Santos2015Fig6b_IC_TixTiz=3_pbki5.mat','pas','wws');
...
print(gcf,'-depsc',['Santos2015Fig6b_IC_TixTiz=3_pbki5_','select.eps']);
savefig(['Santos2015Fig6b_IC_TixTiz=3_pbki5_','select.fig']);
