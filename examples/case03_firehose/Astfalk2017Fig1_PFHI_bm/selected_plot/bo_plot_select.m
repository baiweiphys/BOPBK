...
save('saveData_Astfalk2017Fig1_PFHI_bm.mat','pas','wws');
...
print(gcf,'-depsc',['saveData_Astfalk2017Fig1_PFHI_bm','_select.eps']);
savefig(['saveData_Astfalk2017Fig1_PFHI_bm','_select.fig']);
