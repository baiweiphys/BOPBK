...
save('pbk_EMIC_th=40_B0=100nT_Tsz=1879.mat','pas','wws');
...
print(gcf,'-depsc',['pbk_EMIC_th=40_B0=100nT_Tsz=1879','_select.eps']);
savefig(['pbk_EMIC_th=40_B0=100nT_Tsz=1879','_select.fig']);
