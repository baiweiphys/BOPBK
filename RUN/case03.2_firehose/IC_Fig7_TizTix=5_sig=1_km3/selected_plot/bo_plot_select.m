...
save('Basu2011PoPFig7_TizTix=5_sig=1_km3.mat','pas','wws');
...
print(gcf,'-depsc',['Basu2011PoPFig7_TizTix=5_sig=1_km3_','select.eps']);
savefig(['Basu2011PoPFig7_TizTix=5_sig=1_km3_','select.fig']);
