...
save('Basu2011PoPFig7_TizTix=5_sig=0.5_bm.mat','pas','wws');
...
print(gcf,'-depsc',['Basu2011PoPFig7_TizTix=5_sig=0.5_bm_','select.eps']);
savefig(['Basu2011PoPFig7_TizTix=5_sig=0.5_bm_','select.fig']);
